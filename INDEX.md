...
**⚪ אינם משויכים לחברה בכלל (החלטת מוצר, לא פרצה):** `employees`, `suppliers`, `calendar_events`, קטלוג המוצרים — אין להם `company_id` בסכימה, ולכן הם משותפים לכל הארגון. אם יידרש בעתיד להפריד אותם — זה שינוי סכימה+מוצר, לא תיקון אבטחה.
