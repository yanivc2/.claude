...
-- salaries — employee wage payments (משכורות, ROADMAP §D).
...
-- employees — pension-file compliance tracking (מעקב פנסיה).
CREATE TABLE IF NOT EXISTS employees (
  ...
  prior_pension       INTEGER NOT NULL DEFAULT 0,
  pension_opened      INTEGER NOT NULL DEFAULT 0,
  ...
  release_sent        INTEGER NOT NULL DEFAULT 0,
