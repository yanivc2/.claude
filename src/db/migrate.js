...
function migrateSupplierContacts(db) {
  ...
  // עסקאות בשיעור אפס (fresh produce, §30(א)(13)) — a flag, not TEXT.
  if (!cols.includes('zero_rated')) {
    db.exec('ALTER TABLE suppliers ADD COLUMN zero_rated INTEGER NOT NULL DEFAULT 0;');
  }
