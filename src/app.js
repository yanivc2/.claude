...
import trackedInvoiceRoutes from './routes/trackedInvoices.js';
...
const BUILD_VERSION = '2026-08-30·157';
...
export function createApp() {
  ...
  app.use('/tracked-invoices', requirePageAccess('nav_tracked_invoices'), trackedInvoiceRoutes);
