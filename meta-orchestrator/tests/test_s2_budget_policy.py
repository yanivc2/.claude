...
def test_frozen_paid_spend_ledger_loads_and_totals():
    ...
    # $0.052343 diagnostic + $0.126836 official ($0.023641 historical + final-sequence black-112
    # $0.012028 + black-130 $0.029330 + black-132 $0.029049 FAILED + black-141 $0.032788 SOLVED-leak)
    assert led.total_paid_to_date() == Decimal("0.179179")
    assert Decimal(led.diagnostic_apparatus_spend_usd) == Decimal("0.052343")
    assert Decimal(led.official_training_spend_usd) == Decimal("0.126836")
...
def test_lifetime_spend_plus_worst_binds_global_cap():
    ...
    assert lifetime == Decimal("46.175929")
